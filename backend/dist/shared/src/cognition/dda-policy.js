...
exports.evaluateCognitiveDda = evaluateCognitiveDda;
const exercise_relation_map_1 = require("./exercise-relation-map");
function evaluateCognitiveDda(exerciseSlug, currentLevel, accuracyRate, timeSpentSec, timeLimitSec, masteries) {
    const mapping = exercise_relation_map_1.EXERCISE_RELATION_MAP[exerciseSlug];
...
//# sourceMappingURL=dda-policy.js.map