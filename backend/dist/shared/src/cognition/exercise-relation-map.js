...
exports.EXERCISE_RELATION_MAP = void 0;
exports.getRelationsForExercise = getRelationsForExercise;
exports.EXERCISE_RELATION_MAP = {
    'schulte-table': {
        slug: 'schulte-table',
...
function getRelationsForExercise(slug, level) {
    const map = exports.EXERCISE_RELATION_MAP[slug];
    if (!map)
...
//# sourceMappingURL=exercise-relation-map.js.map