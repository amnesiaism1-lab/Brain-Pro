...
export const INFINITY_ROMAN_NUMERALS = ['∞-I', '∞-II', '∞-III', '∞-IV', '∞-V', '∞-VI', '∞-VII', '∞-VIII', '∞-IX', '∞-X'] as const;

export const getInfinityTier = (level: number): InfinityTier | null => {
  if (level >= 13 && level <= 22) {
    return (level - 12) as InfinityTier;
  }
  return null;
};

export const getInfinityLabel = (level: number): string => {
  const tier = getInfinityTier(level);
  if (tier) {
    return INFINITY_ROMAN_NUMERALS[tier - 1];
  }
  return `Cấp ${level}`;
};

export const INFINITY_LEVEL_CONFIGS: Record<ExerciseSlug, IExerciseLevelConfig[]> = {
  // 1. Đảo ngữ (anagram)
  'anagram': [
    {
      level: 13,
  ...
  // 15. Tìm trong văn bản (text-scanning)
  'text-scanning': [
    {
      level: 13,
      timeLimitSec: 45,
  ...
  'card-flip': [
    {
      level: 13,
      timeLimitSec: 85,
      targetItemCount: 16, // 16 pairs = 32 cards
    ...
    },
    {
      level: 17,
      timeLimitSec: 90,
      targetItemCount: 8, // 8 sets of 3 = 24 cards
  ...
  // 28. Hiệu Ứng Domino Nhân Quả (causal-cascade)
  'causal-cascade': [
    { level: 13, timeLimitSec: 40, targetItemCount: 6, variantCode: 'INF_CAUSAL_CHAIN_RESONANCE', variantName: '∞-I: Causal Chain Resonance', infinityTier: 1, infinityMetadata: { tier: 1, romanNumeral: '∞-I', pattern: 'cascade' }, parametersJson: { infinityMode: true, nodeCount: 8, gateCount: 2 } },
    { level: 14, timeLimitSec: 38, targetItemCount: 6, variantCode: 'INF_CAUSAL_DUAL_INVERSION', variantName: '∞-II: Dual Branching Inversion', infinityTier: 2, infinityMetadata: { tier: 2, romanNumeral: '∞-II', pattern: 'mirror' }, parametersJson: { infinityMode: true, nodeCount: 8, dualInverter: true } },
    { level: 15, timeLimitSec: 35, targetItemCount: 7, variantCode: 'INF_CAUSAL_HIGH_FREQ_PULSE', variantName: '∞-III: High-Frequency Logic Pulse', infinityTier: 3, infinityMetadata: { tier: 3, romanNumeral: '∞-III', pattern: 'rhythm' }, parametersJson: { infinityMode: true, nodeCount: 9, pulseSpeedMs: 150 } },
    { level: 16, timeLimitSec: 35, targetItemCount: 7, variantCode: 'INF_CAUSAL_MULTI_GATE_SYNTH', variantName: '∞-IV: Multi-Node Gate Synthesis', infinityTier: 4, infinityMetadata: { tier: 4, romanNumeral: '∞-IV', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 9, complexGates: true } },
    { level: 17, timeLimitSec: 32, targetItemCount: 8, variantCode: 'INF_CAUSAL_CHAOS_DOMINO', variantName: '∞-V: Chaos Domino Cascade', infinityTier: 5, infinityMetadata: { tier: 5, romanNumeral: '∞-V', pattern: 'chaos' }, parametersJson: { infinityMode: true, nodeCount: 10, distractorFlows: 2 } },
    { level: 18, timeLimitSec: 30, targetItemCount: 8, variantCode: 'INF_CAUSAL_PENDULUM_FLOW', variantName: '∞-VI: Pendulum Flow Interruption', infinityTier: 6, infinityMetadata: { tier: 6, romanNumeral: '∞-VI', pattern: 'pendulum' }, parametersJson: { infinityMode: true, nodeCount: 10, oscillatingDelay: true } },
    { level: 19, timeLimitSec: 28, targetItemCount: 9, variantCode: 'INF_CAUSAL_INVERSE_REASONING', variantName: '∞-VII: Inverse Causal Reasoning', infinityTier: 7, infinityMetadata: { tier: 7, romanNumeral: '∞-VII', pattern: 'mirror' }, parametersJson: { infinityMode: true, nodeCount: 11, reverseInference: true } },
    { level: 20, timeLimitSec: 26, targetItemCount: 9, variantCode: 'INF_CAUSAL_NANO_PROPAGATION', variantName: '∞-VIII: Nanosecond Propagation', infinityTier: 8, infinityMetadata: { tier: 8, romanNumeral: '∞-VIII', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 11, hyperLatencyMs: 80 } },
    { level: 21, timeLimitSec: 25, targetItemCount: 10, variantCode: 'INF_CAUSAL_LATENT_RECON', variantName: '∞-IX: Latent Variable Reconstruction', infinityTier: 9, infinityMetadata: { tier: 9, romanNumeral: '∞-IX', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 12, hiddenGates: 2 } },
    { level: 22, timeLimitSec: 22, targetItemCount: 10, variantCode: 'INF_CAUSAL_ZENITH_SINGULARITY', variantName: '∞-X: Zenith Causal Singularity', infinityTier: 10, infinityMetadata: { tier: 10, romanNumeral: '∞-X', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 13, masterDomino: true } }
  ],

  // 29. Trí Nhớ Ma Trận Đồ Thị (graph-memory-matrix)
  'graph-memory-matrix': [
    { level: 13, timeLimitSec: 35, targetItemCount: 5, variantCode: 'INF_GRAPH_FLASH_RECALL', variantName: '∞-I: Topological Flash Recall', infinityTier: 1, infinityMetadata: { tier: 1, romanNumeral: '∞-I', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 8, memorizeSec: 3.0 } },
    { level: 14, timeLimitSec: 35, targetItemCount: 5, variantCode: 'INF_GRAPH_DUAL_CLUSTER', variantName: '∞-II: Dual Cluster Bridge Memory', infinityTier: 2, infinityMetadata: { tier: 2, romanNumeral: '∞-II', pattern: 'mirror' }, parametersJson: { infinityMode: true, nodeCount: 8, dualClusters: true, memorizeSec: 3.0 } },
    { level: 15, timeLimitSec: 32, targetItemCount: 6, variantCode: 'INF_GRAPH_DYNAMIC_DIRECTED', variantName: '∞-III: Dynamic Directed Flow Recall', infinityTier: 3, infinityMetadata: { tier: 3, romanNumeral: '∞-III', pattern: 'cascade' }, parametersJson: { infinityMode: true, nodeCount: 9, edgeCount: 12, memorizeSec: 2.8 } },
    { level: 16, timeLimitSec: 30, targetItemCount: 6, variantCode: 'INF_GRAPH_3D_SPHERICAL', variantName: '∞-IV: 3D Spherical Node Matrix', infinityTier: 4, infinityMetadata: { tier: 4, romanNumeral: '∞-IV', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 9, spatialDimension: 3, memorizeSec: 2.8 } },
    { level: 17, timeLimitSec: 30, targetItemCount: 7, variantCode: 'INF_GRAPH_CHAOS_SHUFFLE', variantName: '∞-V: Chaos Synapse Shuffling', infinityTier: 5, infinityMetadata: { tier: 5, romanNumeral: '∞-V', pattern: 'chaos' }, parametersJson: { infinityMode: true, nodeCount: 10, permuteNodes: true, memorizeSec: 2.5 } },
    { level: 18, timeLimitSec: 28, targetItemCount: 7, variantCode: 'INF_GRAPH_OSCILLATING_LATTICE', variantName: '∞-VI: Oscillating Connection Lattice', infinityTier: 6, infinityMetadata: { tier: 6, romanNumeral: '∞-VI', pattern: 'pendulum' }, parametersJson: { infinityMode: true, nodeCount: 10, periodicEdges: true, memorizeSec: 2.5 } },
    { level: 19, timeLimitSec: 26, targetItemCount: 8, variantCode: 'INF_GRAPH_MIRROR_RECONSTRUCT', variantName: '∞-VII: Mirror Graph Reconstruction', infinityTier: 7, infinityMetadata: { tier: 7, romanNumeral: '∞-VII', pattern: 'mirror' }, parametersJson: { infinityMode: true, nodeCount: 11, bilateralSymmetry: true, memorizeSec: 2.2 } },
    { level: 20, timeLimitSec: 25, targetItemCount: 8, variantCode: 'INF_GRAPH_DEEP_BOTTLENECK', variantName: '∞-VIII: Deep Bottleneck Tracing', infinityTier: 8, infinityMetadata: { tier: 8, romanNumeral: '∞-VIII', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 11, multipleBottlenecks: 2, memorizeSec: 2.0 } },
    { level: 21, timeLimitSec: 24, targetItemCount: 9, variantCode: 'INF_GRAPH_OCCLUSION_EXTRA', variantName: '∞-IX: Partial Occlusion Extrapolation', infinityTier: 9, infinityMetadata: { tier: 9, romanNumeral: '∞-IX', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 12, occludedNodes: 3, memorizeSec: 2.0 } },
    { level: 22, timeLimitSec: 20, targetItemCount: 10, variantCode: 'INF_GRAPH_OMNISCIENT_MATRIX', variantName: '∞-X: Omniscient Connectome Matrix', infinityTier: 10, infinityMetadata: { tier: 10, romanNumeral: '∞-X', pattern: 'infinite' }, parametersJson: { infinityMode: true, nodeCount: 14, edgeCount: 22, memorizeSec: 1.8 } }
  ],

  // 30. Xung Đột Quy Tắc Biến Dị (rule-mutation-clash)
  'rule-mutation-clash': [
    { level: 13, timeLimitSec: 35, targetItemCount: 10, variantCode: 'INF_RULE_RAPID_INVERSION', variantName: '∞-I: Rapid Rule Inversion', infinityTier: 1, infinityMetadata: { tier: 1, romanNumeral: '∞-I', pattern: 'mirror' }, parametersJson: { infinityMode: true, ruleCount: 4, itemLimitMs: 1200 } },
    { level: 14, timeLimitSec: 35, targetItemCount: 10, variantCode: 'INF_RULE_DUAL_CONDITION', variantName: '∞-II: Dual Condition Mutation', infinityTier: 2, infinityMetadata: { tier: 2, romanNumeral: '∞-II', pattern: 'cascade' }, parametersJson: { infinityMode: true, ruleCount: 4, compoundRules: true, itemLimitMs: 1100 } },
    { level: 15, timeLimitSec: 32, targetItemCount: 11, variantCode: 'INF_RULE_AUDIO_VISUAL_CLASH', variantName: '∞-III: Audio-Visual Rule Clash', infinityTier: 3, infinityMetadata: { tier: 3, romanNumeral: '∞-III', pattern: 'rhythm' }, parametersJson: { infinityMode: true, multiModal: true, pitchStimulus: true, itemLimitMs: 1050 } },
    { level: 16, timeLimitSec: 30, targetItemCount: 11, variantCode: 'INF_RULE_TRI_STATE_SWITCH', variantName: '∞-IV: Tri-State Matrix Switch', infinityTier: 4, infinityMetadata: { tier: 4, romanNumeral: '∞-IV', pattern: 'infinite' }, parametersJson: { infinityMode: true, ruleCount: 5, actionCount: 3, itemLimitMs: 1000 } },
    { level: 17, timeLimitSec: 28, targetItemCount: 12, variantCode: 'INF_RULE_CHAOS_STORM', variantName: '∞-V: Chaos Mutation Storm', infinityTier: 5, infinityMetadata: { tier: 5, romanNumeral: '∞-V', pattern: 'chaos' }, parametersJson: { infinityMode: true, randomMutations: 3, itemLimitMs: 950 } },
    { level: 18, timeLimitSec: 28, targetItemCount: 12, variantCode: 'INF_RULE_PENDULUM_SHIFT', variantName: '∞-VI: Pendulum Metarule Shift', infinityTier: 6, infinityMetadata: { tier: 6, romanNumeral: '∞-VI', pattern: 'pendulum' }, parametersJson: { infinityMode: true, periodicInversionMs: 2000, itemLimitMs: 900 } },
    { level: 19, timeLimitSec: 25, targetItemCount: 13, variantCode: 'INF_RULE_MIRROR_CONFLICT', variantName: '∞-VII: Mirror Symmetry Conflict', infinityTier: 7, infinityMetadata: { tier: 7, romanNumeral: '∞-VII', pattern: 'mirror' }, parametersJson: { infinityMode: true, mirrorBias: true, itemLimitMs: 850 } },
    { level: 20, timeLimitSec: 24, targetItemCount: 13, variantCode: 'INF_RULE_MS_INHIBITION', variantName: '∞-VIII: Millisecond Executive Inhibition', infinityTier: 8, infinityMetadata: { tier: 8, romanNumeral: '∞-VIII', pattern: 'infinite' }, parametersJson: { infinityMode: true, ultraFast: true, itemLimitMs: 800 } },
    { level: 21, timeLimitSec: 22, targetItemCount: 14, variantCode: 'INF_RULE_IMPLICIT_DETECTION', variantName: '∞-IX: Implicit Mutation Detection', infinityTier: 9, infinityMetadata: { tier: 9, romanNumeral: '∞-IX', pattern: 'infinite' }, parametersJson: { infinityMode: true, unannouncedMutation: true, itemLimitMs: 750 } },
    { level: 22, timeLimitSec: 20, targetItemCount: 15, variantCode: 'INF_RULE_SUPREME_FLEXIBILITY', variantName: '∞-X: Supreme Cognitive Flexibility', infinityTier: 10, infinityMetadata: { tier: 10, romanNumeral: '∞-X', pattern: 'infinite' }, parametersJson: { infinityMode: true, hyperFlexibility: true, itemLimitMs: 700 } }
  ]
};
