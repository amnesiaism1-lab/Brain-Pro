...
export const EXERCISES_METADATA: IExercise[] = [
  {
    ...
    iconName: 'Shuffle',
    scientificBasis: 'Kích thích vùng Wernicke và Broca ở bán cầu não trái, tăng tốc độ xử lý ngôn ngữ và độ linh hoạt từ vựng.',
  ...
  },
  {
    ...
    iconName: 'Grid',
    scientificBasis: 'Phương pháp tiêu chuẩn vàng của nhà tâm thần học Walter Schulte để đo lường và mở rộng trường nhìn ngoại biên.',
  ...
  },
  {
    ...
    iconName: 'ToggleLeft',
    scientificBasis: 'Tương tự hiệu ứng Stroop, rèn luyện tốc độ dẫn truyền xung thần kinh và kiểm soát ức chế nhận thức.',
  ...
  },
  {
    ...
    scientificBasis: 'Loại bỏ hoàn toàn thời gian lãng phí do chuyển động mắt nhảy (Saccades) và đọc thầm (Subvocalization).',
  ...
  },
  {
    ...
    iconName: 'Maximize2',
    scientificBasis: 'Tăng cường số lượng thụ thể que (Rods) ở vùng ngoại vi võng mạc, mở rộng vùng thu nhận ký tự.',
  ...
  },
  {
    ...
    iconName: 'Circle',
    scientificBasis: 'Kỹ thuật huyền thoại trong phương pháp Speed Reading của Peter Kump nhằm kích hoạt soft-focus toàn diện.',
  ...
  },
  {
    ...
    iconName: 'Layers',
    scientificBasis: 'Rèn luyện thói quen gom cụm (Chunking), giảm số lần dừng mắt (Fixations) trên mỗi dòng từ 8 lần xuống 2 lần.',
  ...
  },
  {
    ...
    iconName: 'Gauge',
    scientificBasis: 'Công nghệ Bionic Reading làm đậm các ký tự đầu tiên kết hợp máy đếm nhịp dẫn hướng phản xạ thị giác.',
  ...
  },
  {
    ...
    iconName: 'Sparkles',
    scientificBasis: 'Tăng cường dung lượng của Visuo-spatial Sketchpad và hồi hải mã (Hippocampus) thông qua việc ghi nhớ tọa độ không gian.',
  ...
  },
  {
    ...
    iconName: 'Palette',
    scientificBasis: 'Huấn luyện vùng vỏ não trước trán (Dorsolateral Prefrontal Cortex) trong việc kiểm soát ức chế phản xạ vô điều kiện.',
  ...
  },
  {
    ...
    iconName: 'LayoutGrid',
    scientificBasis: 'Chuẩn đánh giá y khoa quốc tế về trí nhớ không gian và khả năng tái lập trình tự chuỗi thị giác.',
  ...
  },
  {
    ...
    iconName: 'Eye',
    scientificBasis: 'Huấn luyện cơ nhãn cầu ngoại lai (Extraocular Muscles), triệt tiêu hiện tượng mỏi mắt và tăng tốc độ giật mắt có chủ đích (Voluntary Saccades).',
...
export const EXERCISE_SYNERGIES: IExerciseSynergy[] = [
  {
    ...
    description: 'Kết hợp Schulte mở rộng góc nhìn và bài tập Tầm Nhìn khóa tâm ngắm giúp tăng 30% diện tích tiếp nhận ký tự.',
    bonusXpPercent: 25
  },
  {
    ...
    description: 'Khởi động mắt bằng bài Chữ Chạy rồi lập tức kiểm tra với Đánh Giá Tốc Độ Đọc để kích hoạt cơ chế đọc không đọc thầm.',
    bonusXpPercent: 20
  },
  {
    ...
    description: 'Tôi luyện vỏ não trước trán với hiệu ứng Stroop kết hợp phân loại Chẵn/Lẻ giúp tăng tốc độ ra quyết định dưới 300ms.',
    bonusXpPercent: 25
  },
  {
  ...
  },
  {
    ...
    description: 'Khởi động cơ vận nhãn với Theo Dõi Mắt Nhanh rồi điều hướng cùng Bionic Pacer giúp mắt lướt mượt mà không mỏi.',
    bonusXpPercent: 25
  },
  {
    ...
    title: 'Cân Bằng Bán Cầu Não',
    description: 'Kích hoạt bán cầu não trái (ngôn ngữ đảo ngữ) và bán cầu não phải (không gian lật thẻ 3D).',
    bonusXpPercent: 30
  },
  {
    ...
    description: 'Điểm xanh kích hoạt tầm nhìn mềm (Soft Focus), Chuỗi từ rèn luyện gom cụm nhảy nhãn cầu theo từng khối ngữ pháp.',
    bonusXpPercent: 20
  }
];
