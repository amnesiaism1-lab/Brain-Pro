...
export const COGNITIVE_RELATIONS: Record<RelationId, ICognitiveRelationDef> = {
  TARGET_POSITION: {
    id: 'TARGET_POSITION',
...
export const ALL_RELATION_IDS: RelationId[] = Object.keys(COGNITIVE_RELATIONS) as RelationId[];
